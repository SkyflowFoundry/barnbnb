...
class SignUpForm extends Component {
  ...
  async signUpHandler(event) {
    ...
    // call sign-up passing in record object and create moov account and upsert skyflow record
        ...
        <div>
          <div className="row justify-content-md-center">
            <div className="col-12 col align-self-center">
              <div style={{ margin: 20 }}>
                <h2 style={{ fontSize: 35 }}>Sign up as a host</h2>
                <form method="POST" onSubmit={this.loginHandler}>
                  ...
                  <div className="mt-3">
                    <Link href="/log-in">
                      <a style={{ width: "100%", backgroundColor: "#eee" }} className="btn btn-light">Already a host? Log in</a>
                    </Link>
                  </div>
