...
export default function Index() {
  return (
    <Layout>
      <Layout title="Barnbnb - Host Home">
        <div>
          ...
          <div className="row justify-content-md-center mt-4" style={{ margin: 0, width: "100%", }}>
            ...
            <div className="row mt-4 gx-2">
              <div className="col-8">
                <p className="fw-bold" style={{ fontSize: 16, marginBottom: 0, marginLeft: 5 }}>Total earnings</p>
              </div>
              <div className="col-4 text-end">
          ...
          <div className="row justify-content-md-center mt-1 gx-0" style={{ margin: 0, width: "100%", }}>
            <div className="row gx-2">
              ...
              <div className="col-4 text-end">
                <p className="text-muted" style={{ fontSize: 16, marginBottom: 0, paddingTop: 5, paddingBottom: 5 }}>$442.00 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-right" viewBox="0 0 16 16">
