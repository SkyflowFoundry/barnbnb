...
export default function Index() {
  return (
    <Layout>
      <Layout title="Barnbnb - Host Payment Transfer">
        <div>
          ...
          <div className="row justify-content-md-center mt-4" style={{ margin: 0, width: "100%", }}>
            <div className="position-absolute top-50 start-50 translate-middle text-center justify-content-md-center">
              ...
              <p style={{ fontSize: 16, marginLeft: 40, marginRight: 40 }} className="text-muted mt-2 fw-light">Transferring $442.00 to your bank account ending in 7000</p>
            </div>
          </div>
